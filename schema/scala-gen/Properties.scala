...
class Properties {
  ...
  override def toString(): String = {
    ...
    sb.append(classOf[Properties].getName).append('@').append(java.lang.Integer.toHexString(System.identityHashCode(this))).append('[')
    sb.append("tags")
    sb.append('=')
  ...
  override def equals(other: Any): Boolean = {
    ...
    if ((other.isInstanceOf[Properties]) == false) {
      return false
    }
    val rhs = other.asInstanceOf[Properties]
