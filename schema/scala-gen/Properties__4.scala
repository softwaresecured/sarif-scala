...
class Properties__4 {
  ...
  override def toString(): String = {
    ...
    sb.append(classOf[Properties__4].getName).append('@').append(java.lang.Integer.toHexString(System.identityHashCode(this))).append('[')
    sb.append("tags")
    sb.append('=')
  ...
  override def equals(other: Any): Boolean = {
    ...
    if ((other.isInstanceOf[Properties__4]) == false) {
      return false
    }
    val rhs = other.asInstanceOf[Properties__4]
